---
title: 'Use Local LLM with Cursor and Ollama'
seoTitle: 'Use Local LLM with Cursor and Ollama'
slug: 'use-local-llm-with-cursor-and-ollama'
description: 'Learn how to set up and use a local Large Language Model (LLM) with the Cursor IDE and Ollama, by leveraging ngrok for local model access.'
pubDate: '2025-05-27'
updatedDate: '2025-05-27'
tags: ['ollama', 'cursor', 'llm']
coverImage: ''
---
